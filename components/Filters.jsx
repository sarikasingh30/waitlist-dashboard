...
import { DatePickC } from "./DatePickC";
...
const Filters = ({
  ...
  }, [searchInput, waitlistData]);

  const handleSelectorRemovePeople= (id) => {
                                ...
                                <div key={person.id} className="person">
                                  <label>
                                    <input
                                      ...
                                      onChange={() =>
                                        handleSelectorRemovePeople(person.id)
                                      }
                                    />
                                    {person.payer}
                                  </label>
