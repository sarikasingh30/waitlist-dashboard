      ...
      <div className="overflow-auto h-[90%]">
        <div className="px-0 ">
          <table className="mt-4 w-full min-w-max table-auto text-left">
            <thead>
              <tr>
                {selectedColumns.includes("Created On") && (
                ...
                {selectedColumns.includes("Payer Phone") && (
                  <th className="border-y p-4">
                    <p className="antialiased ml-2 font-sans text-center  text-sm text-gray-600 flex items-center gap-2 font-normal">
                      <LuHash /> Payer Phone{" "}
                    </p>
                  ...
                  <tr key={el.id}>
                    ...
                    {selectedColumns.includes("Status") && (
                      <td className="p-4 border-b border-blue-gray-50">
                        <div className="w-max">
                          <div
                            className={`flex flex-row items-center font-sans select-none ${
                              el.status == "Inactive"
